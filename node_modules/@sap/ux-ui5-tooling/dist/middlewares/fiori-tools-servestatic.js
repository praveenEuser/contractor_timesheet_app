...
var require_send = __commonJS({
  "../../node_modules/send/index.js"(exports2, module2) {
    ...
    function send(req, path2, options2) {
      return new SendStream(req, path2, options2);
    }
    function SendStream(req, path2, options2) {
      Stream.call(this);
      var opts = options2 || {};
      this.options = opts;
      this.path = path2;
    ...
    SendStream.prototype.stream = function stream(path2, options2) {
      var self2 = this;
      var res = this.res;
      var stream2 = fs.createReadStream(path2, options2);
...
var require_utils = __commonJS({
  "../../node_modules/@sap-ux/serve-static-middleware/dist/base/utils.js"(exports2) {
    ...
    var resolveServeStaticOptions = (options2) => {
      return Object.fromEntries(Object.entries(options2).filter(([key]) => {
...
var require_tail_file = __commonJS({
  "../../node_modules/winston/lib/winston/tail-file.js"(exports2, module2) {
    ...
    module2.exports = (options2, iter) => {
      ...
      fs.open(options2.file, "a+", "0644", (err, fd) => {
        if (err) {
          if (!iter) {
...
var require_vscode_output_channel_transport = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/winston-logger/vscode-output-channel-transport.js"(exports2) {
    ...
    var VSCodeTransport = class extends winston_transport_1.default {
      ...
      constructor(options2) {
        super(options2);
        this.channel = getVSCodeInstance().window.createOutputChannel(options2.channelName, { log: true });
      }
      log(data, callback) {
        setImmediate(() => {
...
module.exports = ({ options: options2, middlewareUtil }) => {
  initI18n();
  ...
  const configuration = options2.configuration;
