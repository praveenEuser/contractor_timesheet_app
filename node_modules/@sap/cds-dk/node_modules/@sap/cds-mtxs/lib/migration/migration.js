...
module.exports.getDbId = async function () {
    return mtxAdapter.getDbId()
}
...
async function _verifyExtension(migrationResult, tenantProjectFolder, tenant, tags, existingCsn, options) {
    ...
    const mainCsn = await mp.getCsn({ tenant, flavor: 'inferred', activated: true, base: true, options: { skipMinify: true } })
